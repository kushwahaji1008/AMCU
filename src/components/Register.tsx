...
export default function Register() {
  ...
  const [dairyContact, setDairyContact] = useState('');
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-stone-50 dark:bg-stone-950 p-4 py-12">
      <div className="max-w-md w-full bg-white dark:bg-stone-900 rounded-3xl shadow-sm border border-stone-100 dark:border-stone-800 p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-serif font-medium text-stone-900 dark:text-white">Register Dairy</h1>
          <p className="text-stone-500 dark:text-stone-400 text-sm">Join the DugdhaSetu network as an Admin</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          <div className="grid grid-cols-1 gap-4">
            <div className="space-y-1">
              <label className="text-xs font-medium text-stone-400 dark:text-stone-500 uppercase tracking-wider">Admin Name</label>
            ...
            <div className="pt-4 border-t border-stone-100 dark:border-stone-800">
              <h3 className="text-sm font-medium text-stone-900 dark:text-white mb-4">Dairy Information</h3>
              
              <div className="space-y-4">
                <div className="space-y-1">
                  <label className="text-xs font-medium text-stone-400 dark:text-stone-500 uppercase tracking-wider">Dairy / Society Name</label>
                  <div className="relative">
                    <Building className="absolute left-3 top-1/2 -translate-y-1/2 text-stone-400 dark:text-stone-500" size={18} />
                    <input
                      type="text"
                      required
                      value={dairyName}
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-stone-50 dark:bg-stone-800 border border-stone-100 dark:border-stone-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-stone-900/5 dark:focus:ring-white/5 transition-all dark:text-white"
                      placeholder="e.g. Amul Dairy Society"
                    />
                  </div>
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-medium text-stone-400 dark:text-stone-500 uppercase tracking-wider">Address</label>
                  <div className="relative">
                    <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 text-stone-400 dark:text-stone-500" size={18} />
                    <input
                      type="text"
                      required
                      value={dairyAddress}
                ...
                <div className="space-y-1">
                  <label className="text-xs font-medium text-stone-400 dark:text-stone-500 uppercase tracking-wider">Contact Number</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      value={dairyContact}
                      onChange={(e) => setDairyContact(e.target.value)}
                      className="w-full pl-10 pr-4 py-3 bg-stone-50 dark:bg-stone-800 border border-stone-100 dark:border-stone-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-stone-900/5 dark:focus:ring-white/5 transition-all dark:text-white"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 bg-stone-900 dark:bg-white text-white dark:text-stone-900 rounded-2xl font-medium hover:bg-stone-800 dark:hover:bg-stone-100 transition-colors disabled:opacity-50 mt-6"
          >
