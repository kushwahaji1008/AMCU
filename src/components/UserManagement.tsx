  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-end">
        <div>
          <h1 className="text-3xl font-serif font-medium text-stone-900">User Management</h1>
          <p className="text-stone-500">Manage system users and access roles</p>
        </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-stone-100">
                  <th className="py-4 px-4 text-xs font-medium text-stone-400 uppercase tracking-wider">User</th>
                  <th className="py-4 px-4 text-xs font-medium text-stone-400 uppercase tracking-wider">Role</th>
                  <th className="py-4 px-4 text-xs font-medium text-stone-400 uppercase tracking-wider">Status</th>
                  <th className="py-4 px-4 text-xs font-medium text-stone-400 uppercase tracking-wider">Last Login</th>
